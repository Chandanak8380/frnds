class FrndsController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to frnds_path, notice: "Not Authorized to Edit or delete this frnd" if @frnd.nil?
  end
  ...
  private
    ...
    def frnd_params
      params.require(:frnd).permit(:first_name, :last_name, :email, :phone, :FavColor, :user_id)
    end
end
