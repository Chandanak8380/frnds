...
class FrndsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frnd" do
    assert_difference("Frnd.count") do
      post frnds_url, params: { frnd: { FavColor: @frnd.FavColor, email: @frnd.email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone: @frnd.phone } }
    end
  ...
  test "should update frnd" do
    patch frnd_url(@frnd), params: { frnd: { FavColor: @frnd.FavColor, email: @frnd.email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone: @frnd.phone } }
